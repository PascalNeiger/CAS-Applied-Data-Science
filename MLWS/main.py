...
parser.add_argument('--batch_size', type=int, default=64) #line 37, 64, 72. 80, 81, 85, 93, 102, 
parser.add_argument('--lr', type=float, default=2e-4) #line 54
parser.add_argument('--loss', type=str, default='hinge') #line 75, 90
parser.add_argument('--checkpoint_dir', type=str, default='checkpoints') #line 126, 131, 132

parser.add_argument('--model', type=str, default='resnet') #line 44
...
def main():
    ...
    for epoch in range(200):
        train(epoch)
        evaluate(epoch)
        torch.save(discriminator.state_dict(), os.path.join(args.checkpoint_dir, 'disc_{}'.format(epoch))) #look up possible data types
